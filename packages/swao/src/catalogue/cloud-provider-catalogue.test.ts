...
// #2124: portfolio-workspace fixture is not always committed; skip fixture-dependent tests gracefully.
const hasPortfolioFixture = existsSync(EXAMPLES_APPS);
...
describe.skipIf(!hasPortfolioFixture)('matchLandingZone -- ghostfolio fixture integration', () => {
...
describe.skipIf(!hasPortfolioFixture)('matchLandingZone -- meshStack live BB bonus (#0097)', () => {
