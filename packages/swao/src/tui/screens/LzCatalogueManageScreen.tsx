  ...
  return (
    <Box flexDirection="column" padding={1}>
      ...
      <GuidanceBox
        ...
        what="Manage LZ service catalogues. copy -- copy a bundled seed to your workspace for editing. new -- scaffold a blank catalogue for a provider not in the bundled set. list --origin -- show all providers with their resolved source."
        details={[
          {
          ...
          },
          {
            label: 'Validation',
            value:
              'Files are schema-validated on every assessment run. A broken edit raises a named parse error -- it does not silently fall back to the seed. Run `swao health-check` to verify edits.',
          },
          {
            label: 'User guide',
