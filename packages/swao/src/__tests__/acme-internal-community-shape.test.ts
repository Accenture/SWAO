...
// #2124: skip when portfolio-workspace fixture is not committed.
describe.skipIf(!existsSync(FIXTURE_ROOT))('acme-internal community fixture (sprint-037 #0341 -- design-029 §11 shape)', () => {
