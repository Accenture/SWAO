...
// #2566: scaffoldPowerBiTemplates skips on Community tier; mock Enterprise
// so the workspace scaffolder test can verify the directory IS created.
...
describe('buildWorkspaceSwaoYml (#1093)', () => {
  ...
  it('produced YAML round-trips through js-yaml without errors', () => {
    const yml = buildWorkspaceSwaoYml({
      ...
      ownerLead: 'owner@example.com', engLead: 'Helmut Schindlwick',
      endDate: '2027-06-30',
    });
