...
//
// Mirrors @swao/swao's src/__tests__/setup.ts (#0573). The relocated
// doctor.test.ts signs licence keys via LicenseGuard.buildKey, which needs the
// Ed25519 private seed in SWAO_LICENSE_SECRET and the matching public key in
