...
export const PublicationSummarySchema = z.object({
  ...
  cloud_native_score: z.number().min(0).max(1).optional(),
  ...
  migration_rationale: z.string().optional(),
}).passthrough();
...
export const ChallengeFindingSchema = z.object({
  id: z.string(),
  severity: z.string().optional(), // #2680: challenge agents do not emit severity
  concern: z.string(),
