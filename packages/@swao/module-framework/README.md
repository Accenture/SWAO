...
The framework loading layer. Discovers, validates, and registers community frameworks from the workspace and the bundled community catalogue. Implements the framework-meta.yaml and controls.yaml schema.
