...
// Re-export shim: implementation has moved to @swao/module-iac-scan (sprint-110 #1320).
...
export type { TfResource, TfState } from '@swao/module-iac-scan';
export {
