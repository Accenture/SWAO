...
![swao init output alongside the created workspace folder](./01-cli-init.png)
...
![swao assess streaming passes for sovereign-health](./03-cli-assess-anthropic.png)
...
![Power BI Application Report dashboard page](./04-powerbi-dashboard-overview.png)
...
![Power BI Compliance page with GDPR control matrix](./05-powerbi-compliance-matrix.png)
...
![Power BI Risks page with risk register and charts](./06-powerbi-risks.png)
...
![Power BI Auditor page with block-level and signal-level assessments](./07-powerbi-auditor.png)
...
![Power BI Portfolio Report overview page with four apps](./08-powerbi-portfolio-overview.png)
...
![Power BI Portfolio Auditor Roll-up page](./09-auditor-md-excerpt.png)
...
![SWAO TUI main menu v0.4.8](./10-tui-main-menu.png)
...
![SWAO TUI Workspace Setup wizard step 1 of 7](./11-tui-workspace-setup.png)
...
![SWAO TUI assessment type selection screen](./13-tui-run-assessment.png)
...
![SWAO TUI Publish HTML screen](./14-tui-publish-html.png)
...
![SWAO MCP connector active in Claude Desktop connectors menu](./15-mcp-connector-claude-desktop.png)
...
![Claude answering a GDPR risk question using live SWAO signals](./16-mcp-deep-dive-question.png)
...
Live assessment reports you can open directly in your browser. Generated by SWAO against the
Sovereign Health demo workspace.

### Application Assessment -- Sovereign Health {#pub-01}
...
A full application compliance report for Sovereign Health, a fictitious patient-management
application. Covers GDPR signal findings, rationale text, risk register, and 7R migration
strategy. All evidence is sourced from static and LLM analysis passes.

---

### Landing Zone Assessment -- Sovereign Health {#pub-02}
...
Landing zone fit/gap report comparing EU sovereign and hyperscaler cloud providers for the
Sovereign Health application. Shows which providers meet the data residency and compliance
requirements derived from the application assessment.

---

### LLM Assessment {#pub-03}
...
Multi-LLM sovereignty benchmarking report. Evaluates several language models against
data-residency, GDPR, and BSI C5 requirements. Includes per-model verdicts and a
recommendation with sourced rationale.
