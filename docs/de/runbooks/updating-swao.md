...
- Versionierte Binaries für jede Plattform (`swao-enterprise-win-x64.exe`, `swao-enterprise-linux-x64`, `swao-enterprise-linux-arm64`, `swao-enterprise-macos-x64`, `swao-enterprise-macos-arm64`)
