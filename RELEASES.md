...
Release page: [github.com/Accenture/SWAO/releases/tag/v1.1.0](https://github.com/Accenture/SWAO/releases/tag/v1.1.0)
...
- `swao chat` command: multi-turn LLM conversation about portfolio assessment results
  (Enterprise licence required).
- Security: fast-uri 3.x -> 4.1.5, fastify -> 5.12.5, liquidjs guard raised.
...
A CycloneDX SBOM (`swao-v1.1.0-community-sbom.cdx.json`) is attached to the
