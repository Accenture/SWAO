...
**Current version:** v1.1.0 (in progress, sprint-135)
**Branch model:** GitHub Flow -- `main` only; sprint PRs squash-merge
**Active sprint:** sprint-135 (SC-001 fixes + SWAO Chat v1.1.0)
**Last closed sprint:** sprint-134 (SWAO-Chat.ps1 + SWAO-Agent.ps1 delivered; 2026-09-11)
**Target release:** v1.1.0 (SWAO Chat -- Enterprise-gated multi-turn portfolio chat)
